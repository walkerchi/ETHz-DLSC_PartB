# Copyright (c) 2023, Walker Chi. All right reserved.
# based on the implementation of NVIDIA Corporation.
#
...
def get_plugin(module_name, sources, headers=None, source_dir=None, **build_kwargs):
    ...
    try: # pylint: disable=too-many-nested-blocks
        ...
        #
        # This optimization is done only in case all the source file`?s reside in
